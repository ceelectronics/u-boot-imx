 ...
 *
 * Configuration settings for the C.E. Electronics, Inc i.MX6Q Elite IV board.
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */

#ifndef __ELITE_COMMON_CONFIG_H
#define __ELITE_COMMON_CONFIG_H
