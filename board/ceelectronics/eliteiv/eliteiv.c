...
printf("In power_init_board, first! \n");
...
int power_init_board(void)
{
printf("In power_init_board LINE 1098 ! \n");
...
printf("location 1307! \n");

	int is_400M;

printf("location 1311! \n");
	unsigned char vddarm;

printf("location 1314! \n");
	struct udevice *dev;
printf("location 1316! \n");
	int ret;


printf("location 1306! \n");
